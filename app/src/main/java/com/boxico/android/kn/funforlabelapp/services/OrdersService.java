...
public interface OrdersService {
    ...
    @POST(API_ROUTE)
    @FormUrlEncoded
    Call<Integer> insertProduct(@Field("insertProduct") boolean insertTag, @Field("tokenFFL") long tokenFFL,
    ...
    @POST(API_ROUTE)
    @FormUrlEncoded
    Call<Integer> insertOnlyTag(@Field("insertOnlyTag") boolean insertTag, @Field("tokenFFL") long tokenFFL,
                            // ORDERS_PRODUCTS
                            @Field("op_products_id") Integer op_products_id,
                            // TAGS
    ...
    @POST(API_ROUTE)
    @FormUrlEncoded
    Call<Integer> insertOnlyTagWithTitle(@Field("insertOnlyTagWithTitle") boolean insertTagWithTitle, @Field("tokenFFL") long tokenFFL,
                                     // ORDERS_PRODUCTS
                                     @Field("op_products_id") Integer op_products_id,
                                     // TAGS
                                     @Field("t_fills_textured_id") Integer t_fills_textured_id,
